...
st.write(dfmap)
st.map(dfmap)
components.iframe(width="600"  height="450"  style="border:0"  loading="lazy"  allowfullscreen src=f"https://www.google.com/maps/embed/v1/place?key={gmaps}&q=Space+Needle,Seattle+WA")
