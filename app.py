...
st.write(gmaps)
url = f"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={lat_user}%2C{long_user}&radius=1500&keyword=rumah+makan|ayam+geprek|bakso|mie+ayam|pecel|nasi+goreng&language=id&key={gmaps}"
