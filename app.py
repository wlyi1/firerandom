...
st.write(gmaps)
url = f"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={lat_user}%2C{long_user}&radius=1500&keyword=rumah+makan or ayam+geprek or nasi+goreng or bakso or mie+ayam or pecel&language=id&key={gmaps}"
